...
&НаСервере
Функция ЗаполнитьНаСервере(НачалоПериода, КонецПериода, ВидДокумента, Организация, Подразделение, Договор, Комментарий, Продукт)
...
Процедура Заполнить(Команда)
	МассивДокументов = ЗаполнитьНаСервере(Объект.НачалоПериода, Объект.КонецПериода, Объект.ВидДокумента, Объект.Организация, Объект.Подразделение, Объект.Договор, Объект.Комментарий, Объект.ПродуктФильтр);
