...
&НаСервере
Функция ЗаполнитьНаСервере(НачалоПериода, КонецПериода, ВидДокумента, Организация)
...
Процедура Заполнить(Команда)
	МассивДокументов = ЗаполнитьНаСервере(Объект.НачалоПериода, Объект.КонецПериода, Объект.ВидДокумента, Объект.Организация);
